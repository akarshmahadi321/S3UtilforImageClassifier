...
public class S3util {
    static String srcBucket = "whizdm.lending.bucket", destBucket = "test.whizdm", excelFileKey = "PanAadharSamples/ExcelSample";
    ...
    public static void main(String[] args) throws IOException, InvalidFormatException {
        ...
        try {
            ...
            for (Row row : sheet) {
                ...
                copyObj(srcBucket, keyName, destBucket, "PanAadharSamples/" + temp, s3Client);
